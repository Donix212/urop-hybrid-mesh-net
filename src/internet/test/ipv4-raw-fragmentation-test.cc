...
class Ipv4RawFragmentationTest : public TestCase
{
  ...
  private:
    ...
    uint32_t m_receivedSize{0};  //!< Size of the last packet received.
    uint32_t m_receivedCount{0}; //!< Total count of packets received.
};
...
Ipv4RawFragmentationTest::DoRun()
{
    ...
    std::vector<uint32_t> sizes = {100, 400, 1600, 6400, 10000, 20000, 50000, 65500};
    for (auto sz : sizes)
    {
        m_receivedCount = 0;
        m_receivedSize = 0;
