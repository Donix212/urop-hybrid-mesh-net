 ...
 */
static const PhyDataAndSymbolRates dataSymbolRates[10]{
    {20.0, 20.0},
    {40.0, 40.0},
    {20.0, 20.0},
    {250.0, 12.5},
 ...
 */
const PhyPpduHeaderSymbolNumber ppduHeaderSymbolNumbers[10]{
    {32.0, 8.0, 8.0},
    {32.0, 8.0, 8.0},
    {32.0, 8.0, 8.0},
    {2.0, 1.0, 0.4},
...
LrWpanPhy::StartRx(Ptr<SpectrumSignalParameters> spectrumRxParams)
{
    ...
    // The reception of the preamble start here
    ///////////////////////////////////////////
...
LrWpanPhy::EndPreamble(Ptr<LrWpanSpectrumSignalParameters> lrWpanRxParams)
{
    ...
    else
    {
        ...
        NS_LOG_DEBUG(this << " transceiver not in RX state is in " << m_trxState);
        m_phyRxDropTrace(p);
    }
