...
LrWpanErrorDistanceTestCase::DoRun()
{
    ...
    // Test that we received slightly less packets out of 1000, at distance less than 100 m
    // with default Tx power of 0 dBm using the default maximum sensitivity
