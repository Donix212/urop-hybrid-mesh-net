...
constexpr std::array<FfrSoftDownlinkDefaultConfiguration, 15> g_ffrSoftDownlinkDefaultConfiguration{
    {
        {1, 15, 2, 0, 4},
        {2, 15, 2, 4, 4},
        {3, 15, 2, 8, 4},
...
constexpr std::array<FfrSoftUplinkDefaultConfiguration, 15> g_ffrSoftUplinkDefaultConfiguration{{
    {1, 15, 3, 0, 4},
    {2, 15, 3, 4, 4},
    {3, 15, 3, 8, 4},
    {1, 25, 6, 0, 6},
