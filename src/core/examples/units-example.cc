...
main(int argc, char** argv)
{
    ...
    std::cout << "\nWe can obtain the linearized value of this dBm_t by calling ";
    std::cout << "toLinearized<double>() on it,\n";
    std::cout << "in addition to the technique demonstrated above of casting it to scalar_t:\n";
    std::cout << "    dBmValue.toLinearized<double>() = " << dBmValue.toLinearized<double>()
              << " (milliWatts, since this was a dBm value)" << std::endl;
