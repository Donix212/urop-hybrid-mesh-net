...
//  * @ingroup sixlowpan-nd-edar-edac-tests
//  *
//  * @brief Test EDAC handling by 6BBR
//  */
// class SixLowPanNdEdacBasicTest : public TestCase
// {
//   public:
//     SixLowPanNdEdacBasicTest()
//         : TestCase("SixLowPanNd EDAC Basic Test")
//     {
//     }
...
//         Ptr<SixLowPanNdProtocol> bbrNdProtocol = bbrNode->GetObject<SixLowPanNdProtocol>();
//         Simulator::Schedule(Seconds(3),
//                             &SixLowPanNdProtocol::SendSixLowPanEDAC,
//                             bbrNdProtocol,
//                             lbrAddr,
//                             bbrAddr,
//                             5120,
