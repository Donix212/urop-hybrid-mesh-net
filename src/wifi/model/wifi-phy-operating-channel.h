...
/**
 * @brief Comparison operator for FrequencyChannelInfo
 *
 ...
 */
inline bool
operator<(const FrequencyChannelInfo& lhs, const FrequencyChannelInfo& rhs)
{
    // Compare by number first, then by frequency, then by width
