...
class DsssErrorRateModel
{
  public:
     ...
     * @return the chunk success rate of the differential BPSK
     */
    static double GetDsssDbpskSuccessRate(scalar_t sinr, uint64_t nbits);
    /**
     ...
     * @return the chunk success rate of the differential encoded QPSK.
     */
    static double GetDsssDqpskSuccessRate(scalar_t sinr, uint64_t nbits);
    /**
     ...
     * @return the chunk success rate of the differential encoded QPSK for
     */
    static double GetDsssDqpskCck5_5SuccessRate(scalar_t sinr, uint64_t nbits);
    /**
     * Return the chunk success rate of the differential encoded QPSK for
     * 11Mbps data rate.
     *
     ...
     * @return the chunk success rate of the differential encoded QPSK for
     */
    static double GetDsssDqpskCck11SuccessRate(scalar_t sinr, uint64_t nbits);
#ifdef HAVE_GSL
