..include::replace.txt.
    ...
    The ns -
    3 stats module provides two different approaches to generating GnuPlot visualizations:
...
Output Modes++ ++ ++ ++ ++ ++
    ...
    **Raw Data Mode**(``GenerateOutput(false)``)
    ...
    - separated data * Maintains backward compatibility with existing examples
