...
- We recommend that new ns-3 modules, intended for the mainline, to wrap their
...
resolution, and for this reason, some modules (such as 5G LENA NR module) heavily
use a prefix on their type names despite using a nested namespace. This style
